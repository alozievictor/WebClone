...
function ExpenditureUnapproval() {
  return (
    <div className="">
      {/* Table */}
      <div className="">
                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>Narration</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Total Number</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Total Amount</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Date Generated</span>
                      </th>
                      <th class="" scope="col"></th>
                    </tr>
                  </thead>
                  <tbody className={style.TableBody}>
                    <tr class="odd">
                      ...
                      <td className="pt-4">2 Of 2</td>
                      <td className="pt-4">January, 2023</td>
                      <td className="pt-4">Electricity Bill</td>
                      <td className="pt-4">1</td>
                      <td className="pt-4">800</td>
                      <td className="pt-4">	2023-08-01 13:27:05</td>
                      <td className="pt-4">
...
export default ExpenditureUnapproval;