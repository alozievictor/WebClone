      ...
      <div className="my-1">
        <form className="container mt-4">
          <div className="row">
            ...
            <div className={"form-group col-md-12"}>
              <label htmlFor="module" className="float-left text-dark">
                Salary Grade <b className="text-danger">*</b>
              </label>
              <input
                type="text"
                class="form-control"
          ...
          <div className="row">
            <div className={"form-group col-md-12"}>
              <label htmlFor="town" className="float-left text-dark">
                Taxable <b className="text-danger">*</b>
              </label>
              <select
                className="form-control valid form-select"
                required
              ...
              >
                <option value="">Please Select</option>
                <option value="ABUJA FCT">Yes</option>
                <option value="ABIA">No</option>
              </select>
              <span
                className="spanValid field-validation-valid"
                data-valmsg-for="town"
            ...
            <div className={"form-group col-md-12"}>
              <label htmlFor="module" className="float-left text-dark">
              Pensionable <b className="text-danger">*</b>
              </label>
              <select
                className="form-control valid form-select"
                required
