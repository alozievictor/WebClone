import style from "../../assets/css/scroll.module.css";
import React, { useEffect } from "react";

function AllowanceTypeModal(props) {
  const closeHandler = () => {
    props.onCancel();
  };
  ...
  return (
    <div className={style.modal}>
      ...
      <div className={`${style.modalContent} ${style.scrollableContent}`}>
      <p>use hook form for the add more logic......</p>
