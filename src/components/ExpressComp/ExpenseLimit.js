                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>Expense Head</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>CATEGORY</span>
                      </th>
                      <th class="">
                  ...
                  <tbody className={style.TableBody}>
                    <tr class="odd">
                      ...
                      <td className="pt-4">DESIGNATION</td>
                      <td className="pt-4">CRA</td>
                      <td className="pt-4">200.00</td>
                      <td className="pt-4">
