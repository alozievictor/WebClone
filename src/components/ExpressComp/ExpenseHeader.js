                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>Expense Type</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Expense Code</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Description</span>
                      </th>
                      <th class="" scope="col"></th>
                    </tr>
                  </thead>
                  <tbody className={style.TableBody}>
                    <tr class="odd">
                      ...
                      <td className="pt-4">OPERATING</td>
                      <td className="pt-4">500</td>
                      <td className="pt-4">TRANSACTION FEE</td>
                      <td className="pt-4">
                        <div class="dropdown">
                          <button
