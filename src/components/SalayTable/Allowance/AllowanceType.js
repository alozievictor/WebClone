...
import AllowanceTypeModal from 'components/subComponent/AllowanceTypeModal';
...
function AllowanceType() {
  ...
  const [isAllowanceType, setIsAllowanceType] = React.useState(false);

  const HandleAllowanceType = () => {
    setIsAllowanceType(true);
  };

  const closehandler = () => {
    setIsAllowanceType(false);
  };
    ...
    <div className="">
      <div className="">
        <Card className="shadow">
          <div class="table_container px-3" data-v-17b4fe89="">
            <div class={style.tableButton} data-v-17b4fe89="">
              ...
              <div class={style.buttonsContainer} data-v-17b4fe89="">
                <button onClick={HandleAllowanceType} className={style.locationBtn} data-v-17b4fe89="">
                  {" "}
              ...
              >
                <thead className={style.Header}>
                  <tr>
                    ...
                    <th><span class={style.HeaderText}>Allowance</span></th>
                    <th class="h1"><span class={style.HeaderText}>Status</span></th>
                    <th class="" scope="col"></th>
                  </tr>
                </thead>
          ...
          <div>
        {isAllowanceType && (
          <AllowanceTypeModal onCancel={closehandler} onConfirm={closehandler} />
        )}
        {isAllowanceType && <Backdrop onClick={closehandler} />}
      </div>
        </Card>
      </div>
    </div>
