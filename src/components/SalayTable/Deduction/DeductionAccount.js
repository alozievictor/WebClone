                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th>
                        <span class={style.HeaderText}>Deduction Account</span>
                      </th>
                      <th class="h1">
                        <span class={style.HeaderText}>Bank Name</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Bank Branch</span>
                      </th>
                      <th class="">
                  ...
                  <tbody className={style.TableBody}>
                    <tr class={style.odd}>
                      ...
                      <td className="pt-4">TECHVIBES INTERNATIONAL LIMITED</td>
                      <td className="pt-4">ADMINISTRATIVE</td>
                      <td className="pt-4">TAX</td>
                      <td className="pt-4">0045154381</td>
                      <td className="pt-4">ACCESS BANK PLC</td>
                      <td className="pt-4">KUBWA BRANCH</td>
                      <td className="pt-4">
...
export default DedicationAccount;
