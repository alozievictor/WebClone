                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="h1">
                        <span class={style.HeaderText}>Employee No</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Updated BY</span>
                      </th>
                      <th>
                        <span class={style.HeaderText}>Updated At</span>
                      </th>
                      <th class="h1">
                        <span class={style.HeaderText}>Section</span>
                      </th>
                      <th class="">
                    ...
                    <tr class={style.odd}>
                      ...
                      <td className="pt-3">
                        <div className={style.bodycont}>
                          ...
                          <span className="pl-2">Mr Jimmy</span>
                        </div>
                      </td>
                      <td className="pt-4">013</td>
                      <td className="pt-4">EDCONBROWN@GMAIL.COM</td>
                      <td className="pt-4">2023-08-03 11:50:00</td>
                      <td className="pt-4">	EMPLOYMENT INFORMATION</td>
                      <td className="pt-4">
