                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>Loan Type</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Determinate Factor</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Interest Type</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>Maximum Loan Tenure</span>
                      </th>
                      <th class="" scope="col"></th>
                    </tr>
                  </thead>
                  <tbody className={style.TableBody}>
                    <tr class="odd">
                      ...
                      <td className="pt-4">SALARY ADVANCEMENT</td>
                      <td className="pt-4">MUST BE A FULL TIME STAFF</td>
                      <td className="pt-4">Fee Null</td>
