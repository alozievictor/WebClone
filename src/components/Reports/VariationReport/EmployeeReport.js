              ...
              <div class="table_container px-3">
                <div class={style.tableButton}>
                  <div class="row col-md-10 col-12 py-3">
                    ...
                    <div className="col-md-2 col-12 py-4">
                      <select
                      ...
                      >
                        <option value="">ALL SUBSIDIARY TYPE</option>
                      </select>
                    </div>
                    <div className="col-md-2 col-12 py-3">
                      <input
                  ...
                  >
                    <thead className={style.Header}>
                      <tr>
                        ...
                        <th class="">
                          <span class={style.HeaderText}>GRADE/STEP</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>SUBSIDIARY</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>CURRENT MONTH</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>CURRENT NET PAY</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>PREVIOUS MONTH</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>PREVIOUS NET PAY</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>VARIATION</span>
                        </th>
                        <th class="">
                          <span class={style.HeaderText}>CURRENT YEAR</span>
                        </th>
                        <th class="" scope="col"></th>
                      </tr>
                    </thead>
