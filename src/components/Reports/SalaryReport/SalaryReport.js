                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>GRADE LEVEL::STEP</span>
                      </th>
                      <th class="">
                      ...
                      <th class="">
                        <span class={style.HeaderText}>HOUSING ALLOWANCE</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>TRANPORT ALLOWANCE</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>OTHER ALLOWANCES</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>GROSS</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>PENSION</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>OTHER DEDUCTIONS</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>NETPAY</span>
                      </th>
                      <th class="">
