              ...
              <div class={style.tableButton}>
                ...
                <div className="col-md-3 col-12 py-3">
                  ...
                  <div className="col-md-3 col-12 py-4">
                    ...
                    >
                      <option value="">ALL BUSINESS BRANCH</option>
                    </select>
                  </div>
                  <div className="col-md-3 col-12 py-4">
                    <select
                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>PROJECT AVG</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>TASK AVG</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>AVERAGE</span>
                      </th>
                      <th class="">
