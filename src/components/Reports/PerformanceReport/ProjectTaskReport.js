                ...
                >
                  <thead className={style.Header}>
                    <tr>
                      ...
                      <th class="">
                        <span class={style.HeaderText}>PROJECT NAME</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>PROJECT HEAD</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>DATE ASSIGNED</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>DUE DATE</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>STATUS</span>
                      </th>
                      <th class="">
                        <span class={style.HeaderText}>PROGRESS</span>
                      </th>
                      <th class="">
